...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] =  public_path().'/upload/'; // Relative to domain name
	$config['upload_path'] = 'http://localhost:8080/mayoutfitnew/public/upload/'; // Physical path. [Usually works fine like this]
