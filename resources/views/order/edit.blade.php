...
@section('content')
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label>No Handphone Penerima</label>
                            <input type="text" class="form-control" name='order_phone' id="order_phone" value='{!!$order_phone!!}'>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label>Nama Pengirim (Dropship)</label>
                            <input type="text" class="form-control" name="order_shipment_name" id="order_shipment_name" value='{!!$order_shipment_name!!}'>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label>No Handphone Pengirim</label>
                            <input type="text" class="form-control" name='order_shipment_phone' id="order_shipment_phone" value='{!!$order_shipment_phone!!}'>
                        </div>
                      </div>
                ...
                <div class="box box-warning">
                  ...
                  <div class="box-body">
                    ...
                    @foreach($detail as $details)
                      <?php 
                          $i++;
                          session()->flash($details->product_id,$details->order_detail_qty);
                      ?>
                   <div class="row data-clone" id="row-{!!$i!!}">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label>Product Name</label>
                            <input type="text" class="form-control product_name" name='product_name[]' id="product_name_{!!$i!!}" value="{!!$details->product_name!!}">
                            <input type="hidden" class="form-control product_id" name='product_id[]' id="product_id_{!!$i!!}" value="{!!$details->product_id!!}">
                            <input type="hidden" class="form-control product_weight" name='product_weight[]' id="product_weight_{!!$i!!}" value="{!!$details->order_detail_weight!!}" >
                            <input type="hidden" class="form-control total_product_weight" name='total_product_weight[]' id="total_product_weight_{!!$i!!}" value="{!!$details->order_detail_subtotal!!}">
                          </div><!-- /.form group -->
                        </div>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control order_detail_price" aria-describedby="basic-addon1" name="order_detail_price[]" id="order_detail_price_{!!$i!!}" value="{!!$details->order_detail_price!!}" readonly="readonly">
                            </div>
                          </div><!-- /.form group -->
                        </div>
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <label>Stock</label>
                              <input type="text" class="form-control product_stock" name="product_stock[]" id="product_stock_{!!$i!!}" value="{!!$details->product_stock!!}" readonly="readonly">
                          </div><!-- /.form group -->
                        </div>
                        ...
                        <div class="col-md-1">
                          <div class="form-group">
                            <label>Quantity</label>
                              <input type="text" class="form-control order_detail_qty" name="order_detail_qty[]" id="order_detail_qty_{!!$i!!}" value="{!!$details->order_detail_qty!!}">
                          </div><!-- /.form group -->
                        </div>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon" id="basic-addon1">Rp</span>
                              <input type="text" class="form-control order_detail_diskon" aria-describedby="basic-addon1" name="order_detail_diskon[]" id="order_detail_diskon_{!!$i!!}" value="{!!$details->order_detail_qty!!}">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon" id="basic-addon1">Rp.</span>
                              <input type="text" class="form-control subtotal" aria-describedby="basic-addon1" name="subtotal[]" id="subtotal_{!!$i!!}" value="{!!$details->order_detail_subtotal!!}" readonly="readonly">
                              @if($i != 1)
                              <span class="input-group-addon" id="basic-addon1"><button class="btn btn-danger btn-xs" type="button" onClick="del_product({!!$i!!})">x</button> </span>
                              @endif
                            </div>
                          </div><!-- /.form group -->
                        </div>
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  <div class="box-body">
                      ...
                      <div class="form-horizontal">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" rows="6" name="order_shipment_address" id='order_shipment_address'>{!!$order_shipment_address!!}</textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name='order_shipment_zip' id='order_shipment_zip' class="form-control" value="{!!$order_shipment_zip!!}">
                            </div>
                          </div>
                        ...
                        <div class="col-md-6">
                              ...
                              <div class="mb15">
                                <div class="input-group">
                                  <span class="input-group-addon">
                                    <div class="radio">
                                      <label><input type="radio" name="paket" value='{!!$reg!!}' class="type_paket" id='reg'>REG</label>
                                    </div>
                                  </span>
                                  <input type="text" class="form-control" aria-label="r1" name='shipment_reg' id="shipment_reg" readonly="readonly" value='{!!$reg!!}'>
                                </div><!-- /input-group -->
                              </div>
                                <div class="input-group">
                                  <span class="input-group-addon">
                                    <div class="radio">
                                      <label><input type="radio" name="paket" value='{!!$yes!!}' class="type_paket" id="yes">YES</label>
                                    </div>
                                  </span>
                                  <input type="text" class="form-control" aria-label="r1" name='shipment_yes' id="shipment_yes" readonly="readonly" value='{!!$yes!!}'>
                                </div><!-- /input-group -->
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name='order_shipment_price' id="order_shipment_price" readonly="readonly" value="{!!$order_shipment_price!!}">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              <input type="text" name="diskon_total" id="diskon_total" class="form-control" value="{!!$diskon_total!!}" >
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="grand_total" id="grand_total" class="form-control" value="{!!$grand_total!!}" readonly="readonly">
                            </div>
                          </div>
                    ...
                    <div class='row'>
                        <div class="col-md-12">
                            <textarea class="form-control" name='order_note' id='order_note' placeholder="Catatan Pembelian">{!!$order_note!!}</textarea>
                        </div>
                    </div>
                  </div>
                </div><!-- /.box-body -->
        ...
        <script type="text/javascript">
          ...
          // });
            ...
            $(document).ready(function(){
                $('.type_paket[value="{!!$type_kirim!!}"]').prop('checked',true);
            });
        </script>
@stop      