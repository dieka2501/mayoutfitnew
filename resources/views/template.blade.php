    ...
    <div class="wrapper">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{!!config('app.url')!!}public/admin/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          @if($role == 'owner')
            @include('menu.menuowner')      
          @elseif($role == 'order')
            @include('menu.menuorder')      
          @else
            @include('menu.menuconfirm')      
          @endif
        </section>
        <!-- /.sidebar -->
      </aside>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a href="http://deasnet.com">Deasnet Persada</a>.</strong> All rights reserved.
      </footer>
